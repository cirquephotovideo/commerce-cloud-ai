-- Fix bulk_create_product_links_cursor: Remove session_replication_role (requires superuser)
-- and optimize timeout handling
...
BEGIN
  ...
  -- Direct batch processing without trigger manipulation
