-- Further reduce batch size in merge_duplicate_analyses_by_ean to avoid timeouts
...
DECLARE
  ...
  link_record RECORD;
BEGIN
  -- Process at most 20 duplicate EAN groups per call to stay well under statement timeout
